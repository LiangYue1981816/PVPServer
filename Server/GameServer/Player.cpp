...
{
	return IS_ENABLE(m_dwFlags, FlagsCode::Code::PLAYER_FLAGS_LOGIN);
}
...
{
	return IS_ENABLE(m_dwFlags, FlagsCode::Code::PLAYER_FLAGS_READY);
}
...
{
	return IS_ENABLE(m_dwFlags, FlagsCode::Code::PLAYER_FLAGS_WAITING);
}
...
{
	return IS_ENABLE(m_dwFlags, FlagsCode::Code::PLAYER_FLAGS_GAMING);
}
