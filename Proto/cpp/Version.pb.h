...
template <> struct is_proto_enum< ::VersionCode::Code> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::VersionCode::Code>() {
  return ::VersionCode::Code_descriptor();
}
