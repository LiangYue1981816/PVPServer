...
inline ::google::protobuf::int32 CreateGame::mapid() const {
  // @@protoc_insertion_point(field_get:ProtoGameClient.CreateGame.mapid)
  return mapid_;
}
inline void CreateGame::set_mapid(::google::protobuf::int32 value) {
  set_has_mapid();
  mapid_ = value;
