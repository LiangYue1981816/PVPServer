...
void protobuf_AddDesc_ProtoGateServer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\014\n\004guid\030\002 \001(\r\"e\n\005Match\022(\n\003err\030\001 \002(\0162\033.Pr"
    "otoGateServer.ERROR_CODE\022\014\n\002ip\030\002 \002(\t:\000\022\020"
    "\n\004port\030\003 \002(\005:\002-1\022\022\n\006gameid\030\004 \002(\005:\002-1\"\r\n\013"
    "CancelMatch\"\303\001\n\016ListGameServer\022(\n\003err\030\001 "
    "\002(\0162\033.ProtoGateServer.ERROR_CODE\022;\n\007serv"
    "ers\030\002 \003(\0132*.ProtoGateServer.ListGameServ"
    ...
    "LOGIN\020\353\007\022\026\n\021ERR_MATCH_TIMEOUT\020\320\017*q\n\014RESP"
    "ONSE_MSG\022\n\n\005HEART\020\270\027\022\n\n\005LOGIN\020\271\027\022\n\n\005MATC"
    "H\020\272\027\022\021\n\014CANCEL_MATCH\020\273\027\022\025\n\020LIST_GAME_SER"
    "VER\020\274\027\022\023\n\016SEND_TO_PLAYER\020\275\027B\002H\001", 831);
...
Match::Match()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:ProtoGateServer.Match)
}
...
Match::Match(const Match& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:ProtoGateServer.Match)
}
...
Match::~Match() {
  // @@protoc_insertion_point(destructor:ProtoGateServer.Match)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:ProtoGateServer.Match)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:ProtoGateServer.Match)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ProtoGateServer.Match)
  return false;
#undef DO_
}
...
void Match::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_end:ProtoGateServer.Match)
}
...
::google::protobuf::uint8* Match::SerializeWithCachedSizesToArray(
  ...
  // @@protoc_insertion_point(serialize_to_array_end:ProtoGateServer.Match)
  return target;
}
...
CancelMatch::CancelMatch()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:ProtoGateServer.CancelMatch)
}
...
CancelMatch::CancelMatch(const CancelMatch& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:ProtoGateServer.CancelMatch)
}
...
CancelMatch::~CancelMatch() {
  // @@protoc_insertion_point(destructor:ProtoGateServer.CancelMatch)
  SharedDtor();
}
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:ProtoGateServer.CancelMatch)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:ProtoGateServer.CancelMatch)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:ProtoGateServer.CancelMatch)
  return false;
#undef DO_
}
...
void CancelMatch::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:ProtoGateServer.CancelMatch)
  if (!unknown_fields().empty()) {
    ::google::protobuf::internal::WireFormat::SerializeUnknownFields(
        unknown_fields(), output);
  }
  // @@protoc_insertion_point(serialize_end:ProtoGateServer.CancelMatch)
}

::google::protobuf::uint8* CancelMatch::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:ProtoGateServer.CancelMatch)
  if (!unknown_fields().empty()) {
    target = ::google::protobuf::internal::WireFormat::SerializeUnknownFieldsToArray(
        unknown_fields(), target);
  }
  // @@protoc_insertion_point(serialize_to_array_end:ProtoGateServer.CancelMatch)
  return target;
}
